                        ...
                        <form onSubmit={handleAddComment} className="flex gap-4 items-start flex-col md:flex-row">
                            ...
                            <div className="flex-1 w-full space-y-3">
                                <MarkdownTextarea
                                    replyContextBar={
                                        replyingToCommentId && (
                                            <div className="flex justify-between items-start bg-brand/5 p-2 px-3 border-b border-border-subtle relative group">
                                                <div className="flex-1 min-w-0 pr-6">
                                                    <div className="flex items-center gap-1 text-[11px] font-bold text-brand uppercase tracking-wider mb-0.5">
                                                ...
                                                <button
                                                    ...
                                                    className="absolute top-2 right-2 text-foreground-muted hover:text-foreground p-1 transition-colors cursor-pointer bg-surface/50 rounded-full hover:bg-surface opacity-0 group-hover:opacity-100"
                                                    title="Cancel reply"
                                                >
