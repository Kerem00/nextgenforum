-- Posts DB Schema Update
ALTER TABLE users ADD COLUMN IF NOT EXISTS role VARCHAR DEFAULT 'user' NOT NULL;
ALTER TABLE posts ADD COLUMN IF NOT EXISTS category VARCHAR DEFAULT 'unknown' NOT NULL;
...
ALTER TABLE comments ADD COLUMN IF NOT EXISTS is_pinned BOOLEAN DEFAULT false NOT NULL;
